...
class ProductImportDataCategoryTemplate implements FromQuery, WithTitle, WithHeadings, WithEvents, ShouldAutoSize
{
    ...
    {
        return \App\Category::query()->select('categories.name as category_name');
    }
