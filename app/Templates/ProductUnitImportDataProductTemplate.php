...
class ProductUnitImportDataProductTemplate implements FromQuery, WithTitle, WithHeadings, WithEvents, ShouldAutoSize
{
    ...
    {
        return \App\Product::query()->select('products.name as product_name');
    }
