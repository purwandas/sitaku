...
class PurchaseImportInputTemplate implements WithHeadings, WithEvents, ShouldAutoSize
{
    /**
    ...
    */
    ...
    {
    	return ['USER NAME', 'SUPPLIER NAME', 'DATE', 'TOTAL PAYMENT', 'TOTAL PAID', 'TOTAL CHANGE'];
    }
