...
class SupplierImportDataProductionTemplate implements FromQuery, WithTitle, WithHeadings, WithEvents, ShouldAutoSize
{
    ...
    {
        return \App\Production::query()->select('productions.name as production_name');
    }
