...
class ProductUnitImportDataUnitTemplate implements FromQuery, WithTitle, WithHeadings, WithEvents, ShouldAutoSize
{
    ...
    {
        return \App\Unit::query()->select('units.name as unit_name');
    }
