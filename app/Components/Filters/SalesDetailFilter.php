...
class SalesDetailFilter extends QueryFilters
{
	...
	public function sales_id($value)
	{
		return is_array($value) ? $this->builder->whereIn('sales_id', $value) : $this->builder->where('sales_id', $value);
	}
