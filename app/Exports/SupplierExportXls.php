...
class SupplierExportXls implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    {
        $filter = new SupplierFilter(new Request(self::$params));
    ...
    {
        return ['NAME', 'ADDRESS', 'PHONE', 'PRODUCTION ID'];
    }
