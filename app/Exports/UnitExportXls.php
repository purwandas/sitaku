...
class UnitExportXls implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    {
        $filter = new UnitFilter(new Request(self::$params));
        return Unit::			select('units.name', 'units.conversion')
			->filter($filter)->get();
    }
